...
Сценарий: <Расчет по среднему (Показания<Среднего)
    ...
    И Я проверяю полученные результаты
        ...
        |Период                |Вид операции           |Организация  |Филиал                        |Строение                                |Помещение |Значение тарифа |Услуга                   |Точка учета                   |Вид начисления |Способ начисления        |Период расчета |Период начисления |Объем услуги |Объем потребленный |Сумма     |Начало периода |Конец периода |Начальные показания |Конечные показания |
