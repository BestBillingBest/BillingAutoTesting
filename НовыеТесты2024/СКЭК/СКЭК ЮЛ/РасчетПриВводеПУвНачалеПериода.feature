...
Сценарий: <РасчетПриВводеПУвНачалеПериода>
    И Я перепровожу регистрацию характеристик договора "Договор № Ввод ПУ в начале периода от 01.01.2024"
        ...
        И Я проверяю полученные результаты
            ...
            |'31.01.2024 23:59:59' |'Начисление ЮЛ 00000000007 от 31.01.2024 23:59:59' |'ОАО "СКЭК"' |'Березовский городской округ' |'Договор № Ввод ПУ в начале периода от 01.01.2024' |'Ввод показаний в начале периода - 1-й Балтийски' |'Холодное водоснабжение' |'ввод_ХВС + водоотведение' |'Начисление'   |'По нормативу'    |''           |'01.01.2024'   |'01.01.2024'      |'35,820'        |''               |'3,000000'   |'3,000000'         |'744,000'                  |'01.01.2024'   |'01.02.2024'  |''                  |''                 |
            И в таблице "Список" я перехожу к строке:
            |Период                |Регистратор                                             |Организация  |Филиал                        |Договор                                            |Объект расчета                                    |Услуга                   |Точка учета                |Вид начисления |Способ начисления |Прибор учета |Период расчета |Период начисления |Значение тарифа |Объем по прибору |Объем услуги |Объем потребленный |Количество часов работы ТУ |Начало периода |Конец периода |Начальные показания |Конечные показания |
            |'31.01.2024 23:59:59' |'Начисление ЮЛ 00000000007 от 31.01.2024 23:59:59' |'ОАО "СКЭК"' |'Березовский городской округ' |'Договор № Ввод ПУ в начале периода от 01.01.2024' |'Ввод показаний в начале периода - 1-й Балтийски' |'Водоотведение'          |'ввод_ХВС + водоотведение' |'Начисление'   |'По нормативу'    |''           |'01.01.2024'   |'01.01.2024'      |'20,530'        |''               |'4,000000'   |'4,000000'         |'744,000'                  |'01.01.2024'   |'01.02.2024'  |''                  |''                 |
            И в таблице "Список" я перехожу к строке:
            |Период                |Регистратор                                             |Организация  |Филиал                        |Договор                                            |Объект расчета                                    |Услуга                   |Точка учета                |Вид начисления |Способ начисления |Прибор учета |Период расчета |Период начисления |Значение тарифа |Объем по прибору |Объем услуги |Объем потребленный |Количество часов работы ТУ |Начало периода |Конец периода |Начальные показания |Конечные показания |
            |'29.02.2024 23:59:59' |'Начисление ЮЛ 00000000008 от 29.02.2024 23:59:59' |'ОАО "СКЭК"' |'Березовский городской округ' |'Договор № Ввод ПУ в начале периода от 01.01.2024' |'Ввод показаний в начале периода - 1-й Балтийски' |'Холодное водоснабжение' |'ввод_ХВС + водоотведение' |'Начисление'   |'По приборам'     |'2223'       |'01.02.2024'   |'01.02.2024'      |'35,820'        |'3,000000'       |'3,000000'   |'3,000000'         |'696,000'                  |'01.02.2024'   |'01.03.2024'  |'9,00'              |'12,00'            |
            И в таблице "Список" я перехожу к строке:
            |Период                |Регистратор                                             |Организация  |Филиал                        |Договор                                            |Объект расчета                                    |Услуга                   |Точка учета                |Вид начисления |Способ начисления |Прибор учета |Период расчета |Период начисления |Значение тарифа |Объем по прибору |Объем услуги |Объем потребленный |Количество часов работы ТУ |Начало периода |Конец периода |Начальные показания |Конечные показания |
            |'29.02.2024 23:59:59' |'Начисление ЮЛ 00000000008 от 29.02.2024 23:59:59' |'ОАО "СКЭК"' |'Березовский городской округ' |'Договор № Ввод ПУ в начале периода от 01.01.2024' |'Ввод показаний в начале периода - 1-й Балтийски' |'Водоотведение'          |'ввод_ХВС + водоотведение' |'Начисление'   |'По приборам'     |'2223'       |'01.02.2024'   |'01.02.2024'      |'20,530'        |'3,000000'       |'3,000000'   |'3,000000'         |'696,000'                  |'01.02.2024'   |'01.03.2024'  |'9,00'              |'12,00'            |