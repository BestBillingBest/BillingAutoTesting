...
Сценарий: <РасчетВСлучаеИзмененияТехническойВозмУстановкиПУ>
    ...
    И Я запускаю выполнение начислений по организации 'ОАО "СКЭК"' и району 'Кемеровский городской округ' и МКД 'Кемерово г, Федоровского ул, Дом № 24' с 'Ноябрь' '2023' по 'Январь 2023'
    И Я проверяю полученные результаты
        ...
        |Период                |Организация  |Филиал                        |Строение                                |Помещение |Значение тарифа |Абонент                         |Услуга                   |Точка учета                   |Способ начисления |Период расчета |Период начисления |Объем услуги |Объем потребленный |Сумма    |Начало периода |Конец периода |Повыщающий коэффициент |Сумма по повышенному коэффициенту |
