...
Сценарий: ОперацииСПломбамиМКД(Замена)
    ...
    И из выпадающего списка "МКД" я выбираю точное значение 'Кемерово г, 1-я Сосновая ул, Дом № 4, Корпус 1'
    Тогда открылось окно 'Операции с пломбами прибора учета МКД (создание) *'
    И из выпадающего списка с именем "ТочкаУчета" я выбираю точное значение '+ввод_Водоотведение'
