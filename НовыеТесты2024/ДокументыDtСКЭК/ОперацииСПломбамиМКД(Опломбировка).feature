...
Сценарий: ОперацииСПломбамиМКД(Опломбировка)
    ...
    И из выпадающего списка "МКД" я выбираю по строке 'Кемерово г, 11-я Линия ул, Дом № 100, Корпус 1'
    Тогда открылось окно 'Операции с пломбами прибора учета МКД (создание) *'
    ...
    |'1' |'132311'     |'+ввод_ХВС + водоотведение_ХВС + водоотведение' |'ХВС + водоотведение' |
    ...
    И в таблице "НомераПломб" из выпадающего списка "Место установки" я выбираю точное значение 'Кухня (под раковиной)'
    И я перехожу к следующему реквизиту
    И в таблице "НомераПломб" в поле 'Номер пломбы' я ввожу текст '988808'
    И в таблице "НомераПломб" я активизирую поле с именем "НомераПломбДатаУстановкиСнятияПломбы"
    ...
    И из выпадающего списка "&Что искать" я выбираю по строке 'Кемерово г, 11-я Линия ул, Дом № 100, Корпус 1'
