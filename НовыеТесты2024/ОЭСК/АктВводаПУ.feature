...
Сценарий: Акт ввода прибора учета
    ...
    И в таблице "Список" я перехожу к строке:
        ...
        | Да                   | ОРИЕНТИР ООО | 'Договор № 0010-77-ЭС от ' | 0010-77-ЭС     | ООО «ОЭСК»  | Москва | Оформляемый | Доходный     |
    И в таблице "Список" я выбираю текущую строку
    Тогда открылось окно 'Акт ввода/вывода/замены прибора учёта (юр. лица) (создание) *'
    ...
    И в таблице "ДанныеТочекУчета" я выбираю текущую строку
    Тогда открылось окно 'Акт ввода/вывода/замены прибора учёта (юр. лица) (создание) *'
    ...
    Когда открылось окно 'Акт ввода/вывода/замены прибора учёта (юр. лица)'
    И в таблице "Список" я перехожу к строке:
        | Вид операции            | Договор                    | Контрагент   | Объект расчета | Организация | Примечание   |Регион |
        | Акт ввода прибора учета | 'Договор № 0010-77-ЭС от ' | ОРИЕНТИР ООО | тест2          | ООО «ОЭСК»  | Автотест     |Москва |
