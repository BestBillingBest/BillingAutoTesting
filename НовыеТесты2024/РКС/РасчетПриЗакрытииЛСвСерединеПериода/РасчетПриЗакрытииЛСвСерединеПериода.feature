...
Сценарий: <РасчетПриЗакрытииЛСвСерединеПериода>
    И Я перепровожу все документы абонента "Тененбаум Виктория Дмитриевна"
    ...
    И Я проверяю полученные результаты
        ...
        |'25.06.2020 23:59:59' |'Тененбаум Виктория Дмитриевна' |'Электроэнергия' |'ввод_Электроэнергия' |'По нормативу'     |'Сутки'         |'4,270'         |'01.06.2020'   |'01.06.2020'      |'768,60' |'180,000000' |''                 |'26.05.2020'   |'26.06.2020'  |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                         |Услуга           |Точка учета           |Способ начисления  |Тарифная зона   |Значение тарифа |Период расчета |Период начисления |Сумма    |Объем услуги |Объем потребленный |Начало периода |Конец периода |
        |'25.06.2020 23:59:59' |'Тененбаум Виктория Дмитриевна' |'Электроэнергия' |'ввод_Электроэнергия' |'По нормативу'     |'Сутки'         |'4,270'         |'01.06.2020'   |'01.06.2020'      |''       |''           |'180,000000'       |'26.05.2020'   |'26.06.2020'  |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                         |Услуга           |Точка учета           |Способ начисления  |Тарифная зона   |Значение тарифа |Период расчета |Период начисления |Сумма    |Объем услуги |Объем потребленный |Начало периода |Конец периода |
        |'25.07.2020 23:59:59' |'Тененбаум Виктория Дмитриевна' |'Электроэнергия' |'ввод_Электроэнергия' |'По нормативу'     |'Сутки'         |'4,270'         |'01.07.2020'   |'01.07.2020'      |'486,78' |'113,999999' |''                 |'26.06.2020'   |'15.07.2020'  |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                         |Услуга           |Точка учета           |Способ начисления  |Тарифная зона   |Значение тарифа |Период расчета |Период начисления |Сумма    |Объем услуги |Объем потребленный |Начало периода |Конец периода |
        |'25.07.2020 23:59:59' |'Тененбаум Виктория Дмитриевна' |'Электроэнергия' |'ввод_Электроэнергия' |'По нормативу'     |'Сутки'         |'4,270'         |'01.07.2020'   |'01.07.2020'      |''       |''           |'113,999999'       |'26.06.2020'   |'15.07.2020'  |