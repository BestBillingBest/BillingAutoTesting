...
Сценарий: <РасчетПриЗаменеПУвНачалеПериода>
    ...
    И Я проверяю полученные результаты
        ...
        |'25.07.2020 23:59:59' |'Волхов г, Полтавская ул, Дом № 13' |'Грачевская Илона Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'   |'По приборам'            |'101010100123' |'Сутки'       |'4,270'         |''          |''             |'339,000000'       |'26.06.2020'   |'26.07.2020'  |
        И в таблице "Список" я перехожу к строке:
        |Период                |Строение                            |Абонент                      |Услуга           |Точка учета           |Вид начисления |Способ начисления        |Прибор учета   |Тарифная зона |Значение тарифа |Сумма       |Объем услуги   |Объем потребленный |Начало периода |Конец периода |
        |'25.07.2020 23:59:59' |'Волхов г, Полтавская ул, Дом № 13' |'Грачевская Илона Сергеевна' |'Электроэнергия' |'ввод_Электроэнергия' |'Начисление'   |'По приборам'            |'101010100123' |'Сутки'       |'4,270'         |'1 447,53'  |'339,000000'   |''                 |'26.06.2020'   |'26.07.2020'  |