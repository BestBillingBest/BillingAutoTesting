...
Сценарий: <РасчетПриПодключенииУслугиВСерединеПериода>
    ...
    И Я проверяю полученные результаты
        ...
        |'25.07.2020 23:59:59' |'Гриценко Наталья Георгиевна' |'Электроэнергия' |'ввод_Электроэнергия' |'По нормативу'    |'Сутки'         |'4,270'         |'01.07.2020'   |'01.07.2020'      |''       |''            |'74,433334'        |'15.07.2020'   |'26.07.2020'   |
        И в таблице "Список" я перехожу к строке:
        |Период                |Абонент                       |Услуга           |Точка учета           |Способ начисления |Тарифная зона   |Значение тарифа |Период расчета |Период начисления |Сумма    |Объем услуги  |Объем потребленный |Начало периода |Конец периода  |
        |'25.07.2020 23:59:59' |'Гриценко Наталья Георгиевна' |'Электроэнергия' |'ввод_Электроэнергия' |'По нормативу'    |'Сутки'         |'4,270'         |'01.07.2020'   |'01.07.2020'      |'317,83' |'74,433334'   |''                 |'15.07.2020'   |'26.07.2020'   |
